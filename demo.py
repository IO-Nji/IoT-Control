...
class Battery:
    ...
    def readVoltage(self):   
        voltage = convert_to_range(self.vPin.read_u16(), 28000, 43000, 0, 100)
        return voltage
...
def displayBattStatus(battLvl, xOrigin=180, yOrigin=114):
    ...
    # Show Battery Level
    drawHorizontalBargraph(0, 100, int(battLvl), colourConverter(20, 255, 40), colourConverter(155, 155, 155), xOrigin, yOrigin + 10)
...
while True:
    ...
    displayBattStatus(battery.readVoltage())
